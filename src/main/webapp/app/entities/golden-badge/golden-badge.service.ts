...
type EntityResponseType = HttpResponse<IGoldenBadge>;
type EntityArrayResponseType = HttpResponse<IGoldenBadge[]>;

@Injectable({ providedIn: 'root' })
export class GoldenBadgeService {
  public resourceUrl = SERVER_API_URL + 'api/golden-badges';
  ...
  update(goldenBadge: IGoldenBadge): Observable<EntityResponseType> {
    return this.http.put<IGoldenBadge>(this.resourceUrl, goldenBadge, { observe: 'response' });
  }
