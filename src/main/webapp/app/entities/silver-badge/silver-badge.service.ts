...
type EntityResponseType = HttpResponse<ISilverBadge>;
type EntityArrayResponseType = HttpResponse<ISilverBadge[]>;

@Injectable({ providedIn: 'root' })
export class SilverBadgeService {
  public resourceUrl = SERVER_API_URL + 'api/silver-badges';
  ...
  update(silverBadge: ISilverBadge): Observable<EntityResponseType> {
    return this.http.put<ISilverBadge>(this.resourceUrl, silverBadge, { observe: 'response' });
  }
