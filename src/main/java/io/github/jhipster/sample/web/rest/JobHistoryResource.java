...
/**
 * REST controller for managing {@link io.github.jhipster.sample.domain.JobHistory}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class JobHistoryResource {
    ...
    public ResponseEntity<List<JobHistory>> getAllJobHistories(Pageable pageable, @RequestParam(required = false, defaultValue = "false") boolean eagerload) {
    ...
    public ResponseEntity<JobHistory> getJobHistory(@PathVariable Long id) {
        ...
        Optional<JobHistory> jobHistory = jobHistoryRepository.findOneWithEagerRelationships(id);
