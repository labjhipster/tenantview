...
import { TheLabelComponent } from 'app/entities/test-root/the-label/the-label.component';
...
describe('Component Tests', () => {
  describe('TheLabel Management Component', () => {
    let comp: TheLabelComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(TheLabelComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.theLabels && comp.theLabels[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
