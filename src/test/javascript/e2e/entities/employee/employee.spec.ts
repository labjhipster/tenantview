...
describe('Employee e2e test', () => {
  ...
  /* it('should create and save Employees', async () => {
        ...
        await promise.all([
            ...
            employeeUpdatePage.sibagSelectLastOption(),
            employeeUpdatePage.gobagSelectLastOption(),
        ...
        expect(await employeeUpdatePage.getHireDateInput()).to.contain('2001-01-01T02:30', 'Expected hireDate value to be equals to 2000-12-31');
  ...
  /* it('should delete last Employee', async () => {
        ...
        expect(await employeeDeleteDialog.getDialogTitle())
            .to.eq('Are you sure you want to delete this Employee?');
