...
export class EmployeeUpdatePage {
  ...
  sibagSelect = element(by.id('field_sibag'));
  gobagSelect = element(by.id('field_gobag'));
  ...
  async sibagSelectLastOption(): Promise<void> {
    await this.sibagSelect.all(by.tagName('option')).last().click();
  }

  async sibagSelectOption(option: string): Promise<void> {
    await this.sibagSelect.sendKeys(option);
  }

  getSibagSelect(): ElementFinder {
    return this.sibagSelect;
  }

  async getSibagSelectedOption(): Promise<string> {
    return await this.sibagSelect.element(by.css('option:checked')).getText();
  }

  async gobagSelectLastOption(): Promise<void> {
    await this.gobagSelect.all(by.tagName('option')).last().click();
  }

  async gobagSelectOption(option: string): Promise<void> {
    await this.gobagSelect.sendKeys(option);
  }

  getGobagSelect(): ElementFinder {
    return this.gobagSelect;
  }

  async getGobagSelectedOption(): Promise<string> {
    return await this.gobagSelect.element(by.css('option:checked')).getText();
  }
