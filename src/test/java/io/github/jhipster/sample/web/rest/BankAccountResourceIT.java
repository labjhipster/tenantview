...
public class BankAccountResourceIT {
    ...
    @Test
    @Transactional
    public void getAllBankAccountsByCompanyIsEqualToSomething() throws Exception {
        // Get already existing entity
        Company company = bankAccount.getCompany();
        bankAccountRepository.saveAndFlush(bankAccount);
        Long companyId = company.getId();

        // Get all the bankAccountList where company equals to companyId
        defaultBankAccountShouldBeFound("companyId.equals=" + companyId);

        // Get all the bankAccountList where company equals to companyId + 1
        defaultBankAccountShouldNotBeFound("companyId.equals=" + (companyId + 1));
    }
