package es.lab.tenantview.repository;

import es.lab.tenantview.TenantviewApp;

import es.lab.tenantview.config.Constants;
import es.lab.tenantview.config.audit.AuditEventConverter;
import es.lab.tenantview.domain.PersistentAuditEvent;
...
import static es.lab.tenantview.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
