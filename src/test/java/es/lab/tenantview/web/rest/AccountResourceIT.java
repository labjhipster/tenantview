...
import es.lab.tenantview.TenantviewApp;
import es.lab.tenantview.config.Constants;
import es.lab.tenantview.domain.User;
import es.lab.tenantview.repository.AuthorityRepository;
import es.lab.tenantview.repository.UserRepository;
import es.lab.tenantview.security.AuthoritiesConstants;
import es.lab.tenantview.service.UserService;
import es.lab.tenantview.service.dto.PasswordChangeDTO;
import es.lab.tenantview.service.dto.UserDTO;
import es.lab.tenantview.web.rest.vm.KeyAndPasswordVM;
import es.lab.tenantview.web.rest.vm.ManagedUserVM;
...
import static es.lab.tenantview.web.rest.AccountResourceIT.TEST_USER_LOGIN;
...
@SpringBootTest(classes = TenantviewApp.class)
